  ...
  [179],
  {
    ...
    4534: function (e, t, r) {
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 15:
                      return (
                        (e.next = 17), W.routeLoader.whenEntrypoint(q.page)
                      );
                    case 17:
                      e.t0 = e.sent;
                    case 18:
                    ...
                    case 36:
                      if (
                        ((t.router = D =
                          k.createRouter(q.page, q.query, U, {
      ...
      var le,
        se = function (e) {
          return function (t) {
            var r = N({}, t, { Component: $, err: q.err, router: D });
    ...
    1003: function (e, t, r) {
      ...
      function H(e, t) {
        ...
        return "/404" === r || "/_error" === r
          ...
          : (t.includes(r) ||
              t.some(function (t) {
                if (w.isDynamicRoute(t) && O.getRouteRegex(t).re.test(r))
                  return (e = t), !0;
              }),
        ...
        function e(t, r, n, o) {
          ...
          !(function (e, t) {
            ...
            (this.onPopState = function (e) {
              ...
              if (t) {
                ...
                m.changeState(
                  "replaceState",
                  j.formatWithValidation({ pathname: T(u), query: c }),
                  b.getURL()
                );
              }
            });
          ...
          if (
            ...
            (S._shouldResolveHref = n !== t),
              this.changeState(
                "replaceState",
                j.formatWithValidation({ pathname: T(t), query: r }),
                b.getURL(),
                S
              );
          }
                          ...
                          switch ((o.prev = o.next)) {
                            ...
                            case 19:
                              if (
                                ...
                                (n = T(
                                  A(L(n) ? I(n) : n, a.locale, c.defaultLocale)
                                )),
                                (R = C(L(n) ? I(n) : n, v.locale)),
                                (c._inFlightRoute = n),
                                (q = m !== v.locale),
                                a._h || !c.onlyAHashChange(R) || q)
                              ) {
                                o.next = 36;
                                break;
                              }
                            ...
                            case 55:
                              if (
                                (c.urlIsNew(R) || q || (t = "replaceState"),
                                (X = n),
                                (z = z ? p.removePathTrailingSlash(I(z)) : z),
                                !l || "/_error" === z)
                              ) {
                                o.next = 70;
                                break;
                            ...
                            case 79:
                              ...
                              (G = s({}, G, K.parsedAs.query)),
                                (X = K.asPath),
                                (z = K.resolvedHref),
                                (U.pathname = K.resolvedHref),
                                (r = j.formatWithValidation(U)),
                                (o.next = 96);
                              break;
                            case 84:
                            ...
                            case 96:
                              ...
                              if (
                                ...
                                (Z = J.pathname),
                                (ee = O.getRouteRegex(Q)),
                                (te = x.getRouteMatcher(ee)(Z)),
                                (ne = (re = Q === Z) ? D(Q, Z, G) : {}),
                                te && (!re || ne.result))
                              ) {
                                o.next = 111;
                            ...
                            case 117:
                              ...
                              if (
                                !(de = le.pageProps.__N_REDIRECT).startsWith(
                                  "/"
                                ) ||
                              ...
                              return (
                                ((he = _.parseRelativeUrl(de)).pathname = H(
                                  he.pathname,
                                  V
                                )),
                                (ye = W(c, de, de)),
                            ...
                            case 146:
                              return (
                                ...
                                (be = a.shallow && v.route === Q),
                                (_e =
                                  null !== (we = a.scroll) && void 0 !== we
                                    ? we
                                    : !be),
                                (Pe = _e ? { x: 0, y: 0 } : null),
                                (o.next = 155),
                            ...
                            case 155:
                              ...
                              throw (
                                (e.events.emit("routeChangeError", ce, R, k),
                                ce)
                              );
                            case 158:
                              return (
                                e.events.emit("routeChangeComplete", n, k),
                                o.abrupt("return", !0)
                              );
                            case 163:
                              if (
                              ...
                              return (
                                (c = _.parseRelativeUrl(
                                  m.normalizeLocalePath(
                                    L(u.rewrite) ? I(u.rewrite) : u.rewrite,
                                    t.locales
                                  ).pathname
                                )),
                            ...
                            case 28:
                              ...
                              return (
                                (h = p.removePathTrailingSlash(
                                  m.normalizeLocalePath(
                                    L(u.redirect) ? I(u.redirect) : u.redirect,
                                    t.locales
                                  ).pathname
                                )),
                                (y = W(t, h, h)),
